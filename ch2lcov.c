...
/* average C freqs., C fluc., covariance and payoffs vs r  */
...
#define adatnev "ch2lcov.d1t"      /* file to store data              */
#define r1          0.0024          /* initial ratio                   */
#define r2          0.0002          /* final ratio                     */
#define rN          11             /* number of different ratios      */
#define L           600            /* lattice size                    */
#define SIZE        (L*L)          /* number of sites                 */
#define NU_OF_NEIG  4              /* number of neighbors             */
#define MC_STEPS    100000          /* run-time in MCS unit            */
...
void main()
 ...
 fprintf(tf,"   r      rhoC0     rhoC1       XC0       XC1     avp0      avp1     covar ");
 fprintf(tf," ch2lcov.c, ");
 ...
 for (rser=0; rser<=rN; rser++)
  {
    ...
    cav[0] = 0.0;   Xav[0] = 0.0;    apo[0] = 0.0;
    cav[1] = 0.0;   Xav[1] = 0.0;    apo[1] = 0.0;
	covar = 0.0;
